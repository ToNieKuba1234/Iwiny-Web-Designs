...
export default function LandingPage() {
    return (
        <section className='flex flex-col min-h-screen gap-5 bg-center bg-no-repeat bg-cover border-b-[1px] border-gray-600 lg:min-h-[50vh] lg:h-auto xl:min-h-screen lg:gap-0 lg:flex-row' style={{background: `url(${LandingBg})`}}>
            ...
            <div className="flex items-center justify-center w-full xl:w-1/2">
                <img src={hero_icon} alt="hero-icon" className="w-3/4 lg:w-3/4"/>
            </div>
        </section>
    )
}
